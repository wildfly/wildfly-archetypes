...
----
$ mvn archetype:generate -DgroupId=my.project.org -DartifactId=sample-javaee-ear-archetype -Dversion=1.0-SNAPSHOT -DarchetypeGroupId=org.wildfly.archetype -DarchetypeArtifactId=wildfly-javaee-ear-archetype -DarchetypeVersion=17.0.0.Final-SNAPSHOT
----